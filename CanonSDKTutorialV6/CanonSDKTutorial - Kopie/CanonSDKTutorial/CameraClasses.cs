...
namespace CanonPulse
{
    public class SDKHandler : IDisposable
    {
        ...
        public delegate void CamErrEventHandler(object sender, EventArgs e, string msg);
        public event CamErrEventHandler camLogMsg;
        /// The used camera
        /// </summary>
        ...
        public uint Error
        {
            ...
            set
            {
                ...
                {
                    if (camLogMsg != null)
                        camLogMsg(this, EventArgs.Empty, "cam Error: " + value);

                    Console.WriteLine("SDK Error: " + value);
                }
            } 
        }
        ...
        /// <summary>
        /// live view has to be paused while communicating with camera
        /// </summary>
                ...
                while (IsLiveViewOn)
                {
                    lock (LVlock)
                    {
                        ...
                        unsafe
                        {
                            ...
                            //fire the live viewUpdated event with the live view image stream
            ...
            new Thread(delegate()
            {
                ...
                lock (LVlock)
                {
                    ...
                    while (BusyCount < 20)
                    {
                        ...
                        if (err == EDSDK.EDS_ERR_DEVICE_BUSY || err == 36103) { 
                            BusyCount++; 
                            Thread.Sleep(50);
                        }
                        else {
